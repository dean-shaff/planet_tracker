...
class App(object):
    ...
    def get_astron_object_data(self, data):
        ...
        self.observer.lon = str(observer_location["lon"])
        self.observer.lat = str(observer_location["lat"])
        self.observer.elevation = float(observer_location["elevation"])
        ...
        astron_obj.compute(self.observer)
